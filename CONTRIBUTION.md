...
This document describes some points about contribution process for baby-bem project.

The project is being developed within community. Maintainer merges pull-requests, fixes critical bugs.

## Codestyle
See [Yandex codestyle](https://github.com/yandex/codestyle/blob/master/javascript.md).
